...
CWindowHandler::CWindowHandler(HINSTANCE hInstance, const TCHAR* szAppName, WindowProc WndProc)
{
	...
	m_hWnd = CreateWindow(szAppName, TEXT("Header"), WS_OVERLAPPEDWINDOW
...
LRESULT CWindowHandler::WndProcDefault(HWND hWnd, UINT uMessage, WPARAM wParam, LPARAM lParam)
{
	HDC hdc;
